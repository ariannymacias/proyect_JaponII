...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-11-2010 a las 20:27:13
...
CREATE TABLE `poblacion` (
  ...
  `total_habitantes` int(11) NOT NULL,
  `total_adultos` int(11) NOT NULL,
  `total_adulto_mayor` int(11) NOT NULL,
  `total_joven` int(11) NOT NULL,
  `total_adolescente` int(11) NOT NULL,
  `total_niño` int(11) NOT NULL,
  `total_niña` int(11) NOT NULL,
  `total_masculino` int(11) NOT NULL,
  `total_femenina` int(11) NOT NULL,
  `observacion` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `vivienda` (
  ...
  `gas` enum('cilindro','tuberia','','') NOT NULL,
...
ALTER TABLE `usuarios`
  ...
  ADD UNIQUE KEY `id_habitante` (`id_habitante`);
...
--
ALTER TABLE `poblacion`
  MODIFY `id_poblacion` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sistema patria`
  MODIFY `id_patria` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `vulnerabiblidad`
  MODIFY `id_vulnerabilidad` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `habitantes_to_sistema_patria`
  ...
  ADD CONSTRAINT `id_patria` FOREIGN KEY (`id_patria`) REFERENCES `sistema patria` (`id_patria`);
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`id_habitante`) REFERENCES `habitantes` (`id_habitantes`),
