...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-11-2010 a las 07:03:35
...
INSERT INTO `beneficios` (`id_beneficios`, `nombre_beneficio`, `status`) VALUES
(1, 'juguete', 'activo'),
(2, 'bolsa CLAP', 'activo'),
...
INSERT INTO `bonos` (`id_bono`, `bono`, `status`) VALUES
...
(1, 'wildimar', 'kariannys', 'diaz', 'araujo', 'V', '28419724', '2002-01-16', 'F', 'kariannys16@gmail.com', '0426', '8070325', ''),
(2, 'henry', 'gabriel', 'escalona', 'fernandz', 'V', '285591590', '2002-08-12', 'M', 'escalonah12@gmail.com', '0412', '5121550', '');
...
--
-- Volcado de datos para la tabla `habitantes_to_beneficios`
--

INSERT INTO `habitantes_to_beneficios` (`id_h_to_v`, `id_habitante`, `id_beneficio`, `id_vivienda`, `id_usuario`, `status`, `fecha_entrega`, `observacion`) VALUES
(0, 2, 2, 2, 7, 'activo', '2010-11-17', '');
...
--
-- Volcado de datos para la tabla `habitantes_to_bonos`
--

INSERT INTO `habitantes_to_bonos` (`id_h_to_b`, `id_habitante`, `id_bono`, `status`, `observacion`) VALUES
(1, 1, 1, 'activo', ''),
(2, 2, 8, 'activo', '');
...
--
-- Volcado de datos para la tabla `habitantes_to_sistema_patria`
--

INSERT INTO `habitantes_to_sistema_patria` (`id_h_to_sp`, `id_habitante`, `id_posee_carnet`, `status`, `observacion`) VALUES
(3, 1, 'si posee', 'activo', ''),
(4, 2, 'no posee', 'activo', '');
...
--
-- Volcado de datos para la tabla `habitantes_to_vulnerabilidad`
--

INSERT INTO `habitantes_to_vulnerabilidad` (`id_h_to_v`, `id_habitante`, `id_vulnerabilidad`, `observacion`) VALUES
(1, 1, 2, ''),
(2, 2, 1, '');
...
INSERT INTO `servicio_to_vivienda` (`id_s_to_v`, `id_vivienda`, `id_servicio`, `observacion`) VALUES
(1, 1, 1, ''),
(2, 2, 4, '');
...
INSERT INTO `usuarios` (`id_usuario`, `nombre_usuario`, `clave`, `id_status`, `id_nivel`) VALUES
(1, 'wildi', 'wildi', 1, 1),
(7, 'henry', 'kiuy089u', 2, 2);
...
(1, 16, 'el tocuyo', 'azul', 4, 2, ''),
(2, 20, 'bolivar', 'blanca', 3, 1, '');
...
INSERT INTO `vulnerabiblidad` (`id_vulnerabilidad`, `vulnerabilidad`, `observacion`) VALUES
(1, 'desnutrición ', ''),
(2, 'sobre peso', ''),
...
--
ALTER TABLE `habitantes`
  MODIFY `id_habitantes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_bonos`
--
ALTER TABLE `habitantes_to_bonos`
  MODIFY `id_h_to_b` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_sistema_patria`
--
ALTER TABLE `habitantes_to_sistema_patria`
  MODIFY `id_h_to_sp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_vulnerabilidad`
--
ALTER TABLE `habitantes_to_vulnerabilidad`
  MODIFY `id_h_to_v` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `servicio_to_vivienda`
  MODIFY `id_s_to_v` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
